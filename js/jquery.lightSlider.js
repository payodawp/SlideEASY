        ...
        plugin = {
            ...
            initialStyle: function () {
                ...
                if(settings.vertical) {
                    ...
                    h=length * ($children.outerHeight() + settings.slideMargin);
                    $el.css('height', h + 'px');
                ...
                if (this.doCss()) {
					...
					if(settings.vertical) {
						...
						if(settings.vertical) {
							...
							top: -v + 'px' }, settings.speed, settings.easing);
							
						} else { 
							
							ob.css('position', 'relative').animate({
							left: -v + 'px'}, settings.speed, settings.easing);
						}                   
                }
            ...
            slide: function () {
				...
				if(settings.vertical) {
                    ...
                    var slideValue = scene * (($children.outerHeight() + settings.slideMargin) * settings.slideMove);
                    $this.active($children, false);
                    if ((slideValue) > w - $children.outerHeight() - settings.slideMargin) {
                        slideValue = w - $children.outerHeight() - settings.slideMargin;
